// app/product/[id]/ProductDetailContent.js
"use client"
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
                ...
                <div className="relative aspect-square bg-gradient-to-br from-blue-400 to-purple-400 rounded-xl overflow-hidden">
                    <div className="w-full h-full flex items-center justify-center text-white">
                        {product.images?.[0] ? (
                            ...
                            <span className="text-lg">{t("product.productImage")}</span>
                        )}
                    </div>
                </div>
                ...
                <div>
                    ...
                    <div className="flex items-center gap-4 mb-4">
                        ...
                        <span className="text-gray-500">(24 {t("product.reviewsSuffix")})</span>
                    </div>
                    ...
                    <div className="mb-6">
                        <p className="text-sm text-gray-500 mb-2">{t("product.availability")}:</p>
                        {product.stock > 0 ? (
                            <p className="text-green-600 font-semibold">{t("common.inStock")} ({product.stock} {t("product.availableWord")})</p>
                        ) : (
                            <p className="text-red-600 font-semibold">{t("common.outOfStock")}</p>
                        )}
                    </div>
                        ...
                        <>
                            ...
                            <div className="flex gap-4">
                                ...
                                >
                                    ...
                                    {isAddingToCart ? t("product.adding") : t("common.addToCart")}
                                </button>
                                ...
                                <button
                                    ...
                                    title={isInWishlist() ? t("product.removeFromWishlistTitle") : t("product.addToWishlistTitle")}
                                >
                                    {isInWishlist() ? (
