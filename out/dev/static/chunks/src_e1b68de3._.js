...
"[project]/src/services/publicApi.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/src/utils/sweetalert.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/src/utils/imageHelper.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$polyfills$2f$process$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = /*#__PURE__*/ __turbopack_context__.i("[project]/node_modules/next/dist/build/polyfills/process.js [app-client] (ecmascript)");
const API_BASE_URL = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$polyfills$2f$process$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].env.NEXT_PUBLIC_API_URL || 'https://backendapi.emcc-lab.com/';
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$publicApi$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/services/publicApi.js [app-client] (ecmascript)");
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$sweetalert$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/utils/sweetalert.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$imageHelper$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/utils/imageHelper.js [app-client] (ecmascript)");
...
function Cart() {
    ...
    const reduxItems = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$redux$2f$dist$2f$react$2d$redux$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useSelector"])({
        "Cart.useSelector[reduxItems]": (state)=>state.cart.items
    }["Cart.useSelector[reduxItems]"]);
    const wishlistItems = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$redux$2f$dist$2f$react$2d$redux$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useSelector"])({
        "Cart.useSelector[wishlistItems]": (state)=>state.wishlist.items
    }["Cart.useSelector[wishlistItems]"]);
    ...
    const fetchCart = async ()=>{
        setIsLoading(true);
        try {
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$api$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["API"].getCart();
            const cartData = response.data;
            if (cartData.items && cartData.items.length > 0) {
                const formattedItems = await Promise.all(cartData.items.map(async (item)=>{
                    let imageUrl = null;
                    try {
                        const productResponse = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$publicApi$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["PublicAPI"].getProduct(item.product_id);
                ...
                dispatch((0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$store$2f$cartSlice$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["setCart"])(formattedItems));
            } else {
                setItems([]);
            }
        } catch (error) {
    ...
    const fetchRecommendedProducts = async ()=>{
        try {
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$publicApi$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["PublicAPI"].getProducts({
                page: 1,
                per_page: 8
            });
            let products = [];
    ...
    const addToCartAndRedirect = async (product)=>{
        ...
        if (!token) {
            ...
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$sweetalert$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["showError"])('Please Login', 'You need to login first to add items to cart');
            router.push('/login');
            return;
        }
        ...
        try {
            ...
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$sweetalert$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["showSuccess"])('Added to Cart', `${product.name} has been added to your cart`);
            // Refresh cart
            await fetchCart();
            ...
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$sweetalert$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["showError"])('Error', error.response?.data?.message || 'Failed to add to cart');
        } finally{
    ...
    const handleUpdateQuantity = async (productId, newQuantity)=>{
        ...
        setIsUpdating(true);
        try {
            await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$api$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["API"].updateCartItem(productId, newQuantity);
            dispatch((0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$store$2f$cartSlice$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["updateQuantity"])({
                productId,
                quantity: newQuantity
            }));
            await fetchCart();
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$sweetalert$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["showSuccess"])('Updated', 'Quantity updated successfully');
        } catch (error) {
            console.error("Error updating quantity:", error);
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$sweetalert$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["showError"])('Error', error.response?.data?.message || "Failed to update quantity");
        } finally{
            setIsUpdating(false);
        }
    };
    const handleRemoveItem = async (productId, productName)=>{
        const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$sweetalert$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["showConfirm"])('Remove Item', `Remove ${productName} from cart?`);
        if (result.isConfirmed) {
            try {
                await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$api$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["API"].removeFromCart(productId);
                dispatch((0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$store$2f$cartSlice$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["removeItem"])(productId));
                await fetchCart();
                await fetchRecommendedProducts();
                (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$sweetalert$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["showSuccess"])('Removed', `${productName} removed from cart`);
            } catch (error) {
                console.error("Error removing item:", error);
                (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$sweetalert$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["showError"])('Error', "Failed to remove item");
            }
        }
    };
    const handleClearCart = async ()=>{
        const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$sweetalert$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["showConfirm"])('Clear Cart', 'Are you sure you want to clear your entire cart?');
        if (result.isConfirmed) {
            try {
                await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$api$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["API"].clearCart();
                ...
                setItems([]);
                (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$sweetalert$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["showSuccess"])('Cleared', 'Cart cleared successfully');
                await fetchRecommendedProducts();
            } catch (error) {
                console.error("Error clearing cart:", error);
                (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$sweetalert$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["showError"])('Error', "Failed to clear cart");
            }
        }
    };
    const handleAddToWishlist = (product)=>{
        try {
            ...
            if (isInWishlist) {
                dispatch((0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$store$2f$wishlistSlice$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["removeFromWishlist"])(product.id));
                (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$sweetalert$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["showSuccess"])('Removed', `${product.name} removed from wishlist`);
            } else {
                dispatch((0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$store$2f$wishlistSlice$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["addToWishlist"])(wishlistItem));
                (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$sweetalert$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["showSuccess"])('Added', `${product.name} added to wishlist`);
            }
        } catch (error) {
            console.error("Error updating wishlist:", error);
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$sweetalert$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["showError"])('Error', 'Failed to update wishlist');
        }
    };
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: [
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    ...
                                    children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$framer$2d$motion$2f$dist$2f$es$2f$components$2f$AnimatePresence$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["AnimatePresence"], {
                                        ...
                                        children: items.map((item)=>{
                                            const imageUrl = item.image ? (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$imageHelper$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getImageUrl"])(item.image) : null;
            ...
            recommendedProducts.length > 0 && items.length > 0 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                className: "mt-16",
                children: [
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("h2", {
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: recommendedProducts.map((product)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$framer$2d$motion$2f$dist$2f$es$2f$render$2f$components$2f$motion$2f$proxy$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["motion"].div, {
                                ...
                                children: [
                                    addingToCart === product.id && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        ...
                                        children: product.images?.[0] ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("img", {
                                            src: (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$imageHelper$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getImageUrl"])(product.images[0].path),
                                            alt: product.name,
...
_s(Cart, "23Jd4dPbk31PO6JIMaZQBC1uqI0=", false, function() {
    return [
...
//# sourceMappingURL=src_e1b68de3._.js.map