...
function Login() {
    ...
    const submit = async (data)=>{
        ...
        setError(null);
        try {
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$api$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["API"].login(data);
            ...
            dispatch((0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$store$2f$authSlice$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["setUser"])(user));
            ...
            if (intendedProduct) {
                ...
                try {
                    ...
                    dispatch((0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$store$2f$cartSlice$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["addToCart"])({
                        id: product.id,
                        name: product.name,
                        price: product.price,
                        quantity: 1
